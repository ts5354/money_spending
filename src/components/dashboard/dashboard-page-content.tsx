    ...
    <section aria-labelledby="dashboard-heading">
      ...
      {loadStatus === "loading" ? (
        ...
        <div className="rounded-2xl border border-slate-200 bg-white px-6 py-16 text-center shadow-card sm:px-10 sm:py-24">
          ...
          <p className="mx-auto mt-3 max-w-lg leading-7 text-slate-600">JCBの利用明細CSVをアップロードしてください。</p>
          <Link className="mt-8 inline-flex min-h-11 items-center justify-center rounded-lg bg-blue-700 px-5 py-3 font-semibold text-white transition hover:bg-blue-800" href="/import">CSVをアップロード</Link>
        </div>
      ) : (
        <>
